import { SeedAdapter, TSignData } from '@tac/signature-adapter';
import { libs, seedUtils } from '@tac/tac-transactions';
...
export function getExplorerUrls(network: string, address: string) {
  ...
  switch (network) {
    case 'mainnet':
      result.walletLink = 'https://wallet.tactoken.io/import/norsu';
      result.activeAddressLink = `https://explorer.tactoken.io/address/${address}`;
      break;
    case 'testnet':
    ...
    case 'stagenet':
      ...
      result.activeAddressLink = `https://stagenet.tactoken.io/address/${address}`;
      break;
    default:
      result.walletLink = 'https://wallet.tactoken.io/import/norsu';
      result.activeAddressLink = `https://explorer.tactoken.io/address/${address}`;
